  ...
  return (
    <div ref={sectionRef} className="h-dvh bg-[#3d4852] flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="section-content text-center z-10 max-w-4xl mx-auto px-4">
        <h1 ref={titleRef} className="text-7xl font-bold text-white mb-6">
          최한결
        </h1>
        
        <p ref={subtitleRef} className="text-xl text-gray-300 mb-12">
          혁신적인 솔루션을 만드는 개발자
        </p>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="highlight-left-item p-6 bg-white/4 rounded-lg backdrop-blur-sm">
            <div className="flex justify-center mb-4">
              <Activity className="w-12 h-12 text-white" />
            </div>
            <h3 className="text-xl font-semibold text-white mb-3">Signal Processing</h3>
            <p className="text-gray-400">실시간 신호 처리 및 알고리즘 최적화</p>
          </div>
          ...
          <div className="highlight-left-item p-6 bg-white/4 rounded-lg backdrop-blur-sm">
            ...
            <p className="text-gray-400">멀티프로세싱과 SIMD를 활용한 성능 최적화</p>
          </div>
          ...
          <div className="highlight-left-item p-6 bg-white/4 rounded-lg backdrop-blur-sm">
            ...
            <p className="text-gray-400">개발팀 리드 및 프로젝트 관리 경험</p>
          </div>

          <div className="highlight-right-item p-6 bg-white/4 rounded-lg backdrop-blur-sm">
            <div className="flex justify-center mb-4">
              <Code2 className="w-12 h-12 text-white" />
            </div>
            <h3 className="text-xl font-semibold text-white mb-3">Multi Language Dev</h3>
            <p className="text-gray-400">C/C++17, C#, Java, React, Python, Rust</p>
          </div>
          ...
          <div className="highlight-right-item p-6 bg-white/4 rounded-lg backdrop-blur-sm">
            ...
            <p className="text-gray-400">논문 기반 알고리즘 연구 및 구현</p>
          </div>
          ...
          <div className="highlight-right-item p-6 bg-white/4 rounded-lg backdrop-blur-sm">
            ...
            <p className="text-gray-400">도전적인 기술 문제 해결</p>
          </div>
        </div>
