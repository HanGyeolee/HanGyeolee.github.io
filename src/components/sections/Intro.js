...
import Underwater from '../../components/animations/underwater.tsx';
...
const IntroSection = () => {
  ...
  return (
    <div ref={sectionRef} className="h-lvh bg-[#4A74AF] flex flex-col items-center justify-center relative">
      {/* 배경 그라데이션 */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#BAD8FF] to-[#17498B]"></div>
      ...
      <Underwater>
        ...
        <ResponsiveContainer>
          <div className="section-content text-center z-10 max-w-5xl mx-auto px-4">
            ...
            <p id="subtitle" className="text-xl text-darkgray-200 mb-12">
              혁신적인 솔루션을 만드는 개발자
            </p>
